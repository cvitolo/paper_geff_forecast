...
# This code chunk uses forecast data, which is not open.
# The code is commented out and the result is provided in the form of a table
...
df_used <- readRDS("../data/SYNOPtable.rds")

d <- df_used %>%
  select(fwiobs, ERA5, HRES_d2, HRES_d6, HRES_d10) %>%
